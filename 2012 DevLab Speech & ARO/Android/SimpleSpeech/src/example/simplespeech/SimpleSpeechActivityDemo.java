...
public class SimpleSpeechActivityDemo extends Activity {
    ...
    **/
    ...
    private void startSpeechActivity() {
        ...
        recognizerIntent.putExtra(ATTSpeechActivity.EXTRA_REQUEST_URL, 
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent resultData) {
        if (requestCode == SPEECH_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                ArrayList<String> textList = resultData.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                ...
                String errorMessage = (resultData != null)
                        ? resultData.getStringExtra(ATTSpeechActivity.EXTRA_ERROR_MESSAGE)
                            : "(no explanation)";
